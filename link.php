<?php
  ...
  $auth0 = new \Auth0\SDK\Auth0(array(
    'domain'        => 'warrenprasad.auth0.com ',
    'client_id'     => 'kaABBXgJ2Xitr6ecaT3uEuEh07XgtaAB',
    'client_secret' => '2RoGWgIwJpjJSEL-Kdsum2l-TCAtDN8kKld3izSO02B5q6IjVtwpvw2Ft1Db_Wq1',
    'redirect_uri'  => 'http://localhost/onelink03/index.php'
  ));
...
<form class="form-horizontal">
  <div class="form-group">
    <div class="col-sm-8">
      <input type="text" class="form-control" id="appname" placeholder="App Name" width="90%">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-8">
      <input type="url" class="form-control" id="androidlinkp" placeholder="Password">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-10">
      <input type="url" class="form-control" id="androidlinkt" placeholder="Email">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Email</label>
    <div class="col-sm-10">
      <input type="url" class="form-control" id="inputEmail3" placeholder="Email">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Email</label>
